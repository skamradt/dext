...
dcc32 "%TOOL_DIR%\DextFacadeGenerator.dpr" -B -Q ^
  -I"%~dp0..\..\Libs\DelphiAST\Source;%~dp0..\..\Libs\DelphiAST\Source\Lexers;%~dp0..\Sources" ^
  -U"%~dp0..\..\Libs\DelphiAST\Source;%~dp0..\..\Libs\DelphiAST\Source\Lexers;%~dp0..\Sources;%~dp0..\Sources\Core;%~dp0..\Sources\Data;%~dp0..\Sources\Web;%~dp0..\Sources\Core\Base;%~dp0..\Sources\Core\Json;%~dp0..\Sources\Web\Hosting;%~dp0..\Sources\Web\Routing;%~dp0..\Sources\Web\Formatters;%~dp0..\Sources\Web\Mvc;%~dp0..\Sources\Web\Indy;%~dp0..\Sources\Web\Caching;%~dp0..\Sources\Hosting\CLI;%~dp0..\Sources\Hosting\CLI\Commands;%~dp0..\Sources\Web\Middleware" ^
