...
export class DextHubConnection {
    ...
    async start() {
        ...
        this._triggerHandlers('ConnectionStateChanged', 'connecting');
        ...
        try {
            ...
            this._triggerHandlers('ConnectionStateChanged', 'connected');
            this._triggerHandlers('connected', { connectionId: this.connectionId });

        } catch (error) {
            this.state = 'disconnected';
            this._triggerHandlers('ConnectionStateChanged', 'disconnected');
            throw error;
        }
    }
    ...
    async _handleReconnect() {
        ...
        this._triggerHandlers('ConnectionStateChanged', 'reconnecting');
